...
const DarkModeToggle = () => {
  ...
  return (
    <button
      ...
      className="relative inline-flex items-center justify-center p-2 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 group"
